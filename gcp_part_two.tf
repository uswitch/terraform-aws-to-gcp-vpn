...
resource "google_compute_external_vpn_gateway" "external_gateway" {
  ...
  name            = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-external-vpn-gateway"
...
resource "google_compute_vpn_tunnel" "tunnel-to-aws-connection-0-ip0" {
  ...
  name = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-vpn-tunnel-1-ip-1"
...
resource "google_compute_vpn_tunnel" "tunnel-to-aws-connection-0-ip1" {
  ...
  name = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-vpn-tunnel-1-ip-2"
...
resource "google_compute_vpn_tunnel" "tunnel-to-aws-connection-1-ip0" {
  ...
  name = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-vpn-tunnel-2-ip-1"
...
resource "google_compute_vpn_tunnel" "tunnel-to-aws-connection-1-ip1" {
  ...
  name = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-vpn-tunnel-2-ip-2"
...
resource "google_compute_router_interface" "router_interface1" {
  name = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-interface-1"
...
resource "google_compute_router_peer" "gcp-to-aws-bgp1" {
  name            = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-peer-bgp-1"
  router          = google_compute_router.gcp-router.name
...
resource "google_compute_router_interface" "router_interface2" {
  name       = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-interface-2"
  router     = google_compute_router.gcp-router.name
...
resource "google_compute_router_peer" "gcp-to-aws-bgp2" {
  name            = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-peer-bgp-2"
  router          = google_compute_router.gcp-router.name
...
resource "google_compute_router_interface" "router_interface3" {
  name       = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-interface-3"
  router     = google_compute_router.gcp-router.name
...
resource "google_compute_router_peer" "gcp-to-aws-bgp3" {
  name            = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-peer-bgp-3"
  router          = google_compute_router.gcp-router.name
...
resource "google_compute_router_interface" "router_interface4" {
  name       = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-interface-4"
  router     = google_compute_router.gcp-router.name
...
resource "google_compute_router_peer" "gcp-to-aws-bgp4" {
  name            = "${data.google_compute_network.gcp-network.name}-to-${data.aws_ec2_transit_gateway.aws-transit-gateway.id}-router-peer-bgp-4"
  router          = google_compute_router.gcp-router.name
